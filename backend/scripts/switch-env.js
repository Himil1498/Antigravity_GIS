...
if (env === 'development') {
    console.log('  Database: localhost:5433 (PostgreSQL)');
    ...
    console.log('  Database: 172.16.20.11:5432 (PostgreSQL)');
    console.log('  Server: http://172.16.20.11:82');
    console.log('  Frontend CORS: http://172.16.20.11:81');
    console.log('');
