 ...
 * @param {String} toolType - Type of tool (sector, polygon, etc.)
 * @param {String} action - Action performed (create, update, delete)
 * @param {Object} data - Data associated with the action
 * @returns {Number} Number of clients message was sent to
 */
const broadcastGISUpdate = (toolType, action, data) => {
  return websocketServer.broadcastGISUpdate(toolType, action, data);
};
