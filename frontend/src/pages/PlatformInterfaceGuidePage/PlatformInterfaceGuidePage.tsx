...
type FlowTab = "workspace" | "help" | "notifications";
...
const WORKSPACE_FLOW: StepData[] = [
  {
    id: 1,
    title: "Post Login — Main Map Page",
    description: [
      "After successful login, the user lands natively on the Main Map Page.",
      "This serves as the primary workspace of the GIS Platform for viewing and editing topology."
    ],
    icon: MapIcon,
    theme: "blue"
  },
  {
    ...
    description: [
      "The top navigation bar acts as the global command center.",
      "Key Modules: Map, GIS Data Hub, Network Planning, Dashboard, Users, Groups, Admin, Analytics, Tools.",
      "Contains global action toggles including: Dark/Light Mode, Notifications, and Profile Menu."
    ],
...
const HELP_FLOW: StepData[] = [
  {
    id: 1,
    title: "Learning & Documentation",
    description: [
      "User Guide: Interactive, step-by-step documentation on major features.",
      "Flow Diagrams: Visual architectures of application processes.",
      "Video Tutorials: Rich media demonstrations of network mapping."
    ],
    icon: BookOpenText, // Map to HelpCircle down below since BookOpenText isn't imported from lucide-react yet, wait, I imported HelpCircle.
    theme: "purple"
  },
  {
    id: 2,
    ...
    description: [
      "Database Schema: Interactive ER Diagram of the PostgreSQL database.",
      "API Documentation: Endpoint definitions and integration protocols.",
      "Server Architecture: Visual representations of the backend topography."
    ],
    icon: Terminal,
    theme: "emerald"
  }
...
const NOTIFICATIONS_FLOW: StepData[] = [
  {
    id: 1,
    title: "Notification Management",
    description: [
      "Instantly view the latest alerts triggered by system events or role changes.",
      "Bulk Actions: Mark all notifications as read or delete entire batches.",
      "View detailed history by navigating to the dedicated Notification Page."
    ],
    icon: BellRing,
    theme: "amber"
  },
  {
    id: 2,
    title: "Profile & Session Control",
    description: [
      "Session Metrics: Monitor Session Started Time and exact Expiry Time.",
      "Account Options: Manage Security & 2FA, View Profile, or Request Region Access.",
      "Organization Data: View Company Name, Total Regions Assigned, and specific access lists."
    ],
    icon: UserCircle2,
    theme: "rose"
  }
...
const TABS = [
  { id: "workspace", label: "Main Workspace & Navbar", icon: Navigation },
  { id: "help", label: "Help & Technical Menu", icon: HelpCircle },
  { id: "notifications", label: "Notifications & Profile", icon: Settings }
];

export const PlatformInterfaceGuidePage: React.FC = () => {
  const navigate = useNavigate();
  const [activeTab, setActiveTab] = useState<FlowTab>("workspace");
  ...
  const getActiveFlow = () => {
    switch(activeTab) {
      case "workspace": return WORKSPACE_FLOW;
      case "help": return HELP_FLOW;
      case "notifications": return NOTIFICATIONS_FLOW;
      default: return WORKSPACE_FLOW;
    }
  };
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1 font-medium">
              Complete architectural breakdown of Post-Login Navigation & Systems.
            </p>
          </div>
        </div>
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <motion.div 
                      layoutId="activeTabIndicatorInterface"
...
export default PlatformInterfaceGuidePage;
