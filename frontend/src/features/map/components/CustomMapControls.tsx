...
import { CustomMapControlsProps, MapTypeSwitcherProps, ControlButtonProps } from './CustomMapControlsTypes';
import { showToast } from '../../../utils/toastUtils';

const CustomMapControls: React.FC<CustomMapControlsProps> = ({ map, showMyLocation = true, showCenterToIndia = true, showMapTypeSwitch = true }) => {
...
const MyLocationButton: React.FC<ControlButtonProps> = ({ onClick }) => {
  useEffect(() => {
...
const CenterToIndiaButton: React.FC<ControlButtonProps> = ({ onClick }) => {
  useEffect(() => {
    const button = document.createElement('button');
    button.innerHTML = `
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
const MapTypeSwitcher: React.FC<MapTypeSwitcherProps> = ({ currentType, onTypeChange }) => {
