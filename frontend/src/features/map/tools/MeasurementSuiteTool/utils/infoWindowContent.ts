...
export const createHighPointInfoContent = (
  ...
  return `<div class="elevation-info-window" style="padding: 10px; font-family: system-ui;">
...
export const createHoverInfoContent = (dataPoint: ElevationDataPoint): string => {
  return `<div class="elevation-info-window" style="padding: 10px; min-width: 160px; font-family: system-ui;">
...
export const createPinnedInfoContent = (
  ...
  return `<div class="elevation-info-window" style="padding: 14px; min-width: 220px; font-family: system-ui; background: linear-gradient(to bottom, #f0fdf4 0%, #ffffff 100%);">
