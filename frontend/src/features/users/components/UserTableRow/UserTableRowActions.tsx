...
interface UserTableRowActionsProps extends Omit<
  UserTableRowProps,
  "isSelected" | "onSelect"
> {}

const UserTableRowActions: React.FC<UserTableRowActionsProps> = ({
  user,
  onView,
  onEdit,
  onDelete,
  ...
  return (
    <div className="flex gap-2">
      ...
      {onDisable2FA && user.mfaEnabled ? (
        <button
          onClick={() => onDisable2FA(user)}
