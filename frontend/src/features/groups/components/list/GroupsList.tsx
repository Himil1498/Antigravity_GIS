...
import { GroupsListProps } from '../../types/GroupsListTypes';

const GroupsList: React.FC<GroupsListProps> = ({ groups, selectedGroups = [], onSelectGroup, onSelectAll, onEdit, onDelete, onView }) => {
  if (groups.length === 0) {
    return (
                ...
                <div className="flex items-center flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 flex items-center space-x-4 text-sm">
                      ...
                      <div className="flex items-center px-3 py-1 bg-gray-50 dark:bg-gray-900/20 rounded-lg">
                        <svg
                          className="flex-shrink-0 mr-1.5 h-4 w-4 text-gray-600 dark:text-gray-400"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
