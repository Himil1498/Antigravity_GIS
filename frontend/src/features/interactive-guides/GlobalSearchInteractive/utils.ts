import { ColorClasses, ColorMap } from './types';
...
export const getColorClasses = (color: string): ColorClasses => {
  const colors: ColorMap = {
    ...
    cyan: { bg: 'bg-cyan-50 dark:bg-cyan-900/20', text: 'text-cyan-700 dark:text-cyan-300', border: 'border-cyan-200 dark:border-cyan-800' },
