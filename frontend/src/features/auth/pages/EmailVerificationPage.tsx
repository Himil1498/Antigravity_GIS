...
import { VerificationResponse, VerificationStatus } from "../types/EmailVerificationPageTypes";
...
const EmailVerificationPage: React.FC = () => {
  ...
  const verifyEmail = async () => {
    ...
    try {
      // Use environment variable or fallback to port 82
      const BACKEND_API_URL =
        process.env.REACT_APP_API_URL || "http://localhost:82/api";
      const fullUrl = `${BACKEND_API_URL}/auth/verify-email/${token}`;

      const response = await axios.get<VerificationResponse>(fullUrl);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">OptiConnect GIS</p>
        </div>
          ...
          {status === "success" && (
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Your account is now fully activated. You can now log in and
                start using OptiConnect GIS.
              </p>
