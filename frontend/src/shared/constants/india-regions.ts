...
export const INDIA_ADMIN_REGIONS = [
  ...
  { name: 'Goa', lat: 15.2993, lng: 74.1240, zoom: 9 },
  { name: 'Gujarat', lat: 22.2587, lng: 71.1924, zoom: 7 },
  { name: 'Haryana', lat: 29.0588, lng: 76.0856, zoom: 7 },
  { name: 'Himachal Pradesh', lat: 31.1048, lng: 77.1734, zoom: 7 },
  ...
  { name: 'Ladakh', lat: 34.1526, lng: 77.5770, zoom: 7 },
  ...
  { name: 'Punjab', lat: 31.1471, lng: 75.3412, zoom: 7 },
  ...
  { name: 'Tripura', lat: 23.9408, lng: 91.9882, zoom: 8 },
