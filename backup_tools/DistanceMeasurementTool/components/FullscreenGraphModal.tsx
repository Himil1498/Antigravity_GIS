      ...
      <div className="bg-white dark:bg-gray-800 w-full h-full p-8 flex flex-col">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center">
              ...
              Distance Measurement - Elevation Profile
            </h3>
            ...
            <div className="mt-3 space-y-1">
              <p className="text-sm text-amber-600 dark:text-amber-400 flex items-center font-semibold">
                <span className="inline-block w-2 h-2 bg-amber-500 rounded-full mr-2 animate-pulse"></span>
                Hover over graph to preview location on map
              </p>
              <p className="text-sm text-red-600 dark:text-red-400 flex items-center font-semibold">
                <span className="inline-block w-2 h-2 bg-red-500 rounded-full mr-2 animate-pulse"></span>
                Click on graph to pin location marker
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2 mr-4">
              <button
                onClick={exportKML}
                className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-4 py-2 rounded-lg transition-all flex items-center space-x-2 font-semibold shadow-md text-sm"
                title="Export to KML format"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
              ...
              <button
                onClick={exportGPX}
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-4 py-2 rounded-lg transition-all flex items-center space-x-2 font-semibold shadow-md text-sm"
                title="Export to GPX format"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
              ...
              <button
                onClick={exportCSV}
                className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-4 py-2 rounded-lg transition-all flex items-center space-x-2 font-semibold shadow-md text-sm"
        ...
        <div className="mt-6 flex justify-center items-center space-x-8 text-sm flex-wrap gap-3">
          ...
          <div className="flex items-center space-x-2 bg-purple-50 dark:bg-purple-900/20 px-4 py-2 rounded-lg border border-purple-200 dark:border-purple-800">
            <div
              className="w-5 h-5 bg-purple-600 border-2 border-white shadow-sm"
          ...
          <div className="flex items-center space-x-2 bg-red-50 dark:bg-red-900/20 px-4 py-2 rounded-lg border border-red-200 dark:border-red-800">
            <svg
              className="w-6 h-6"
              viewBox="0 0 24 24"
              fill="#ef4444"
